...
const StudentCommunityChat = () => {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row bg-gray-900 text-white">
      ...
      {/* Desktop Communities Sidebar */}
      <aside
        className={`hidden md:flex w-80 bg-gray-800 p-4 md:p-6 overflow-y-auto border-l border-gray-700 flex-col`}
        style={{
          scrollbarWidth: 'none',
          msOverflowStyle: 'none'
        }}
